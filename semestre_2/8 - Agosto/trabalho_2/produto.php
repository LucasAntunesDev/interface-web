    ...
    lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr]">
        ...
        <div class="py-10 lg:col-span-2 lg:col-start-1 lg:pb-16 lg:pr-8 lg:pt-6">
          <div>
            ...
            <div class="space-y-6">
              <p class="text-md text-gray-900 max-w-xl">
          ...
          <div class="mt-10">
            <h3 class="text-xl font-bold text-gray-900">Destaques ✅</h3>
      ...
      <div class="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
        <div class="aspect-h-4 aspect-w-3 hidden overflow-hidden rounded-lg lg:block">
          <img src="assets/home_office.png" class="h-full w-full object-cover object-center">
        </div>
        <div class="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
          <div class="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
            <img src="assets/home_office_2.png" class="h-full w-full object-cover object-center">
          </div>
          <div class="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
            <img src="assets/home_office_3.png" class="h-full w-full object-cover object-center">
          </div>
        </div>
        <div class="aspect-h-5 aspect-w-4 lg:aspect-h-4 lg:aspect-w-3 sm:overflow-hidden sm:rounded-lg">
          <img src="assets/home_office_4.png" class="h-full w-full object-cover object-center">
        </div>
      </div>
