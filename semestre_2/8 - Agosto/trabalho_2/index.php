...
antialiased bx-border">
    ...
    bg-contain">
        ...
        <section class="h-[30rem] bg-contain flex flex-col items-center justify-center
            ...
            <h1 class="text-zinc-50 font-bold text-4xl text-center drop-shadow-sm">
    ...
    <section class="flex justify-center items-center pt-8">
       ...
       gap-y-4 w-[70%] gap-x-10">
            ...
            <textarea name="" id="" cols="" rows="10" class="bg-zinc-50 shadow-md
            rounded-md pr-8" placeholder="Digite a sua mensagem"></textarea>
